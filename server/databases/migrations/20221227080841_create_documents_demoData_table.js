...
exports.up = function (knex) {
    return knex.schema.createTable('documents_DemoData', function (table) {
        table.increments();
        ...
        table.integer('createdBy').nullable().index().references('id').inTable('documents_DemoData')
            .onUpdate('CASCADE')
            .onDelete('SET NULL');
        table.integer('updatedBy').nullable().index().references('id').inTable('documents_DemoData')
            .onUpdate('CASCADE')
            .onDelete('SET NULL');
    });
};
